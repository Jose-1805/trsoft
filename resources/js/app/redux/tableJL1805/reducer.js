...
const reducer = (state=init_state, action) => {
    ...
    switch (action.type) {
        ...
        case types.SET_CONFIG:
            ...
            break;
        //asigna los headers de la tabla
        case types.SET_HEADERS:
            config_tables = state.config_tables;
            let current_config = config_tables[action.id_table];
            if(current_config){
                current_config.headers = action.headers;
                config_tables[action.id_table] = current_config;
                return Object.assign({}, state, {'config_tables':config_tables})
            }
            break;
