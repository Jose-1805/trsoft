...
const Body = ({config, t}) => {
	...
	return <Table.Row>
		<Table.Cell colSpan={headers.length} textAlign='center'>{t('tableJL1805.empty')}</Table.Cell>
	</Table.Row>
}
...
export default withTranslation()(connect(mapStateToProps, mapDispatchToProps)(Body));